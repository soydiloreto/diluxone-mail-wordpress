...
https://wordpress.org/support/plugin/diluxone-mail/

For security vulnerabilities, do NOT open a public PR — use GitHub Security Advisories:
https://github.com/soydiloreto/diluxone-mail/security/advisories/new
-->
...
- [ ] Tested against a real SMTP provider (not only Mailpit)
...
- [ ] User-facing strings are wrapped in WordPress translation functions with the `diluxone-mail` text domain.
